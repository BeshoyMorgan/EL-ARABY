...
import { ProductsComponent } from './My_Component/products/products.component';
...
const routes: Routes = [
  ...
  {path:'',component:MainLayoutComponent,children:[
    ...
    {path:'Home/Products',component:ProductsComponent,title:'Products', canActivate:[UserGuardsGuard]},
    {path:'Products/Products/:pid',component:ProductDetailsComponent,title:'Product details', canActivate:[UserGuardsGuard]}, // id
    {path:'Products/Edit/:pid',component:EditProductComponent,title:'Edit Product', canActivate:[UserGuardsGuard]}, // id
    // Users/Products/1 
    {path:'Products/:pid',component:ProductDetailsComponent,title:'Product details', canActivate:[UserGuardsGuard]},
    {path:'Edit/:pid',component:EditProductComponent,title:'Edit Product', canActivate:[UserGuardsGuard]},
    {path:'Users/UsersDetails/:uid',component:UsersDetailsComponent,title:'User details', canActivate:[UserGuardsGuard]}, // id
    {path:'Home/Products/Products/:pid',component:ProductDetailsComponent,title:'Product details', canActivate:[UserGuardsGuard]}, // id
    {path:'Products',component:ProductsComponent,title:'Products', canActivate:[UserGuardsGuard]},
    {path:'Users',component:UsersComponent,title:'Users', canActivate:[UserGuardsGuard]},
    {path:'ADD',component:AddProductComponent,title:'ADD Product', canActivate:[UserGuardsGuard]},
